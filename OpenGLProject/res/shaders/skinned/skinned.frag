...
// Meme borne que Constants::MAX_LIGHTS_SOURCES (= 10) cote CPU, et que
// m_lightUniformNames reserve dans LightManager::LightManager(). Tous les
// slots non utilises voient leurs uniforms initialises par le ShaderManager
// au link ; on les ignore dans la boucle via numberLightSources.
#define MAX_POINT_LIGHTS 10
uniform PointLight lightSources[MAX_POINT_LIGHTS];
// IMPORTANT : nom identique a LightManager::applyToShader
// (cf. OpenGLProject/LightManager.cpp ligne ~73).
...
// Nom identique a Spotlight::applyToShader.
...
void main() {
    ...
    // Loop plafonne par MAX_POINT_LIGHTS (10), evitant tout OOB read sur le
    // cote CPU pour les slots non initialises.
