...
// ModelLoader
//
// Charge tous les modèles 3D du jeu (backpack, fropy, personnage 3P riggé +
// clips d'animation Mixamo) sur un thread séparé avec contexte OpenGL partagé,
// puis instancie le CharacterAnimationController.
//
...
private:
    void loadDecorModels();    // backpack + fropy
