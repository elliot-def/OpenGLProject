...
PauseMenu::PauseMenu(Game* game, std::vector<std::unique_ptr<TextRenderer>>* textRenderers, ShaderManager* shaderManager)
    : Menu(game, textRenderers, shaderManager, "Pause", false)
{
